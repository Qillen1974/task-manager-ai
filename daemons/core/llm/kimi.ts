...
const log = createLogger("core.llm.kimi");
...
export class KimiClient implements LLMClient {
  ...
  constructor(apiKey: string) {
    ...
    log.debug("Kimi client initialized", {
    ...
    this.http = axios.create({
      ...
      timeout: 180_000, // Kimi may need longer for complex file processing tasks
    });
  }
  ...
  private parseChoice(
    ...
    // Check the standard OpenAI tool_calls field
