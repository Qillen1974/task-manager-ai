      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="grid md:grid-cols-1 gap-8">
            {/* Email */}
            <div className="bg-blue-50 border border-blue-200 p-10 rounded-2xl">
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4">
                    For questions, feature requests, feedback, or technical support, send us an email and we'll get back to you as soon as possible.
                  </p>
                  <a
            ...
            {/* Response Time */}
            <div className="bg-gray-50 border border-gray-200 p-10 rounded-2xl">
              <div className="flex gap-6 items-start">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-16 w-16 rounded-lg bg-gray-600">
